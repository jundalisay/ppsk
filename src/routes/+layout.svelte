<script lang="ts">
	...
	import {faSun, faSignIn, faSignOut, faGears, faPlusCircle, } from "@fortawesome/free-solid-svg-icons";
...
<!-- bg-base-200 -->
<main class="container md:w-[800px] px-8 mx-auto">
	<div class="flex justify-between items-center border-b border-primary pb-2 mb-8">

		<h1 class="font-bold uppercase"><a href="/">Pantrypoints Circle</a></h1>
		...
		<div class="inline-flex items-center gap-3">
			<form method="post" class="form-control" use:enhance={updateTheme}>
				<div class="dropdown dropdown-end">
					...
					<label tabindex="0" class="btn btn-sm btn-ghost rounded-btn">
						<Fa icon={faSun} />
					</label>
					<!-- svelte-ignore a11y-no-noninteractive-tabindex -->
